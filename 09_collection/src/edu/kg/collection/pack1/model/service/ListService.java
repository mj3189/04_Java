package edu.kg.collection.pack1.model.service;

import java.util.List;
import java.util.Scanner;

import edu.kg.collection.pack1.model.dto.Book;
...
//		List list = new ArrayList(); //10칸 짜리 생성
		...
		for(int i = 0 ; i < list.size() ; i++) {
			...
			// List의 i번째 요소가 int인 경우 ( -> Integer 변환)인 경우
		...
		public void method2() {
			...
			// String 타입으로 제한 된 ArrayList 객체 생성
